...
// LoggerFactory.getLogger(ProductStorage.class);

// private static final Map<String, Integer> T_PRODUCT_FIELD_LENGTH = new
// HashMap<>();
...
// private final Map<String, Product> storage = new ConcurrentHashMap<>(16,
// 0.8f, 4);
...
// private void checkLength(/* @NotNull */ String fieldName, /* @NotNull */
// String value) {
...
// private void averMandatoryString(String name, String label, String value,
// boolean allowEmpty) {
// if (value == null) {
...
// public /* @Nullable */ Product addProductToStorage(/* @NotNull */ Product
// product) {
...
// Product itemInDb = findProductByCode(product.getCode());
// if (itemInDb == null) {
// throw new RuntimeException("product code=[" + product.getCode() + "] not
// found in storage");
// }
...
// if (itemInDb == null) {
// throw new RuntimeException("product code=[" + code + "] not found in
// storage");
// }
...
// p.println(" `code` VARCHAR(" + T_PRODUCT_FIELD_LENGTH.get("code") + ") NOT
// NULL,");
// p.println(" `name` VARCHAR(" + T_PRODUCT_FIELD_LENGTH.get("name") + ") NOT
// NULL,");
// p.println(" `category` VARCHAR(" + T_PRODUCT_FIELD_LENGTH.get("category") +
// ") NOT NULL,");
// p.println(" `brand` VARCHAR(" + T_PRODUCT_FIELD_LENGTH.get("brand") + ")
// DEFAULT NULL,");
// p.println(" `type` VARCHAR(" + T_PRODUCT_FIELD_LENGTH.get("type") + ")
// DEFAULT NULL,");
// p.println(" `description` VARCHAR(" +
// T_PRODUCT_FIELD_LENGTH.get("description") + ") DEFAULT NULL,");
// p.println(" `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,");
// p.println(" `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE
// CURRENT_TIMESTAMP,");
// p.println(" PRIMARY KEY (`id`),");
// p.println(" UNIQUE KEY `UX_product_code` (`code`)");
// p.println(") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4
...
// p.print(") VALUES (");
// p.print(item.getId());
// p.append(", ").append('"').append(item.getCode().replace("\"",
// "\"\"")).append('"');
// p.append(", ").append('"').append(item.getName().replace("\"",
// "\"\"")).append('"');
// p.append(", ").append('"').append(item.getCategory().replace("\"",
// "\"\"")).append('"');
// if (item.getBrand() != null && !item.getBrand().isEmpty()) {
// p.append(", ").append('"').append(item.getBrand().replace("\"",
// "\"\"")).append('"');
// }
// if (item.getType() != null && !item.getType().isEmpty()) {
// p.append(", ").append('"').append(item.getType().replace("\"",
// "\"\"")).append('"');
// }
// if (item.getDescription() != null && !item.getDescription().isEmpty()) {
// p.append(", ").append('"').append(item.getDescription().replace("\"",
// "\"\"")).append('"');
// }
// p.println(");");
// }
